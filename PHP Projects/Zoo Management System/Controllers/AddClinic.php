...
if (isset($_POST['Location'], $_POST['Capacity'], $_POST['Operating_Hours'], $_POST['CManager_Id'])) {
    // Fetch values from the form submission
    $Location = $_POST['Location'];
    $Capacity = $_POST['Capacity'];
    $Operating_Hours = $_POST['Operating_Hours'];
    $CManager_Id = $_POST['CManager_Id'];

    // Execute the AddClinic procedure with the provided inputs
    $procedure_query = "EXEC AddClinic @Location = ?, @Capacity = ?, @Operating_Hours = ?, @CManager_Id = ?";
    $params = array($Location, $Capacity, $Operating_Hours, $CManager_Id);
